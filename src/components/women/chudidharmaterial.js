...
const Chudidharmaterial = () => {
    const [data, setData] = useState([]);
    
        const getChudidharmaterialData = async () => {
            const res = await axios.get("/getChudidharmaterial", {
                headers: {
...
export default Chudidharmaterial;