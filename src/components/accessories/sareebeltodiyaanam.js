...
const Sareebeltodiyaanam = () => {
    const [data, setData] = useState([]);
    
    const getSareebeltodiyaanamData = async () => {
        const res = await axios.get("/getSareebeltodiyaanam", {
            headers: {
...
export default Sareebeltodiyaanam;