...
const Boyssharvaniset = () => {
    const [data, setData] = useState([]);

    const getBoyssharvanisetData = async () => {
        const res = await axios.get("/getBoyssharvaniset", {
            headers: {
...
export default Boyssharvaniset;