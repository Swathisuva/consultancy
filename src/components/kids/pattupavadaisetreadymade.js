...
const Pattupavadaisetreadymade = () => {
    const [data, setData] = useState([]);
    
    const getPattupavadaisetreadymadeData = async () => {
        const res = await axios.get("/getPattupavadaisetreadymade", {
            headers: {
    ...
    useEffect(() => {
        getPattupavadaisetreadymadeData()
    }, [])
    return(
        <>
...
export default Pattupavadaisetreadymade;